#ifndef LIFO_ROUTING_PACKET_QUEUE_H
#define LIFO_ROUTING_PACKET_QUEUE_H

#include "ns3/routing-packet-queue.h"

namespace ns3 {

class LifoRoutingPacketQueue: public RoutingPacketQueue {
public:
  static TypeId GetTypeId (void);
  
  LifoRoutingPacketQueue ();
  virtual ~LifoRoutingPacketQueue ();
...
#endif //LIFO ROUTING PACKET QUEUE
