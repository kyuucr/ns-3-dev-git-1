...
#ifndef BACKPRESSURE_HEADER_H
#define BACKPRESSURE_HEADER_H
...
// 3.3.  Packet Format
//
//    The basic layout of any packet in BACKPRESSURE is as follows (omitting IP and
//    UDP headers):
//
//        0                   1                   2                   3
...
public:  
  ...
  struct Hello
  {
    ...
    //new flags to the hello header: added due to multiradio
    //we have to extended it to make the distributed version
    uint8_t n_interfaces;
    std::vector<uint8_t> qLength_eth;
    //uint8_t sending_interface; //sending IP address
    //////////////////////////////////
    
    //uint8_t ProbingHeader;
