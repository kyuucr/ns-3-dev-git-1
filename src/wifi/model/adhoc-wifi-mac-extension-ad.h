...
class AdhocWifiMacExtensionAd : public AdhocWifiMacExtensionInterface, public RegularWifiMacExtensionAd
{
public:
  AdhocWifiMacExtensionAd (const Ptr<WifiMac> &mac);

  Ptr<MultiBandElement> GetMultiBandElement (void) const;
  virtual void ExtendBeacon(MgtBeaconHeader *header);
};
