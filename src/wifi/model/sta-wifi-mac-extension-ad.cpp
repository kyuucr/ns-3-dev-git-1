...
#include "sta-wifi-mac-ad.h"

namespace ns3 {

StaWifiMacExtensionAd::StaWifiMacExtensionAd(const Ptr<WifiMac> &mac)
...
StaWifiMacExtensionAd::GetMultiBandElement (void) const
{
  ...
  multiband->SetChannelNumber (DynamicCast<StaWifiMacAd> (m_mac)->m_phy->GetChannelNumber ());
  multiband->SetBssID (DynamicCast<StaWifiMacAd> (m_mac)->GetBssid ());
...
void
StaWifiMacExtensionAd::ExtendBeacon(MgtAssocRequestHeader *header)
{
