...
public:
  ...
  {
    AddTestCase (new NeighborTest, TestDuration::QUICK);
    AddTestCase (new TypeHeaderTest, TestDuration::QUICK);
    AddTestCase (new HelloHeaderTest, TestDuration::QUICK);
    AddTestCase (new PositionHeaderTest, TestDuration::QUICK);
    AddTestCase (new GpsrRqueueTest, TestDuration::QUICK);
  }
} g_gpsrTestSuite;
